...
const PRIVACY: Section[] = [
  ...
  { heading: "Storage & security", body: ["In this version your data lives on your device and is not transmitted to our servers. When server features are enabled, data will be encrypted in transit (TLS) and at rest, with access controls and least-privilege practices."] },
  {
    heading: "Sharing",
    bullets: [
      "Payment processor (Stripe) to handle billing — we never receive your full card number.",
      "Google, only if you choose to connect Gmail, under its permissions.",
