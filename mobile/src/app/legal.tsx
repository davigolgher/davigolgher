/**
 * Legal & privacy documents, native. The text comes from the shared
 * `features/legal/content`, so it is word-for-word what the web app shows.
 */
...
function isDocId(v: unknown): v is LegalDocId {
...
export default function Legal() {
  ...
  const id: LegalDocId = isDocId(doc) ? doc : "privacy";
  const sections = DOCS[id];
  ...
  return (
    <View className="flex-1 bg-ink-950">
      ...
      >
        <Pressable onPress={() => router.back()} className="py-1 active:opacity-60">
